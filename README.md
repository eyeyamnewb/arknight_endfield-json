hello, and welcome to the endfield dataset repository, 

i got addicted to playing endfield thanks to its factory aspect , played the game since it was on release week.
thanks to that addiction i made a simple dataset to be used with large language model to calculate and do optimization to my factory.
...
![alt text](https://static.icy-veins.com/images/arknights-endfield/operators-squares/snowshine.png "ign profile foto")
